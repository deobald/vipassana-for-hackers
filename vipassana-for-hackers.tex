...
In Figure~\ref{fig:anapana-sense-map}, we can see our attention is (realistically) not perfectly tuned and narrowed to a tiny spot under our nose. We are still likely to hear sounds around us on the third day of the course, especially if the sound is monkeys clambering over the roof of the meditation hall.
...
Through this process, attention will move from the sense of touch to all the internal senses and the sense map will look more like Figure~\ref{fig:vipassana-sense-map}.

\begin{figure}[h]
  \centering
  \includegraphics[width=8cm]{images/ma-vipassana1.png}
  \caption{Vipassana sense map.}
  \label{fig:vipassana-sense-map}
\end{figure}
