...
\begin{abstract}
 \todo{Meditation requires a time commitment. Like other activities we consider
...
in format. It usually involves multiple techniques, including \textit{Open
  Monitoring} which is characterized by
