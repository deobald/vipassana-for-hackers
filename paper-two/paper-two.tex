...
due to the temporary down regulation of the prefrontal cortex.
 \todo{So? What does this mean?} As the meditations get deeper the DMN
...
{What does this mean? What is an example of ``alternative networks of consciousness''?} 
It is as if losing the influence of one's own narrative leads to new insights that are
