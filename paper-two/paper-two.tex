...
\todo{Introduce both the Limbic System and Somatosensory Cortex here, at a very high
  level.}
...
\todo{Expand on IPL: Why is facial recognition interesting to this paper?}
...
conscious awareness by activity in the mPFC \todo{The mPFC needs to be mentioned
  earlier, defined, and abbreviated.} , as influenced by changing internal
...
\todo{Define and describe the Medial Temporal Subsystem: Describe MTL anatomically and MTS relation
  to the DMN, particularly the partial inclusion of the LS. Use the Anatomical
  introduction (immediately following the Introduction) to assist in framing this.}
...
This network \todo{Which network?} has also been activated during autobiographical memory retrieval,
...
\todo{Expand on DMN relationship to Monkey Mind. Add papers with supporting evidence?}
...
as well as a variety of other brain regions \todo{What other brain regions provide
  input to the PPC?}, and it integrates this input to facilitate
...
\todo{PSC section mentions Parietal Lobe but it hasn't been mentioned earlier, nor defined?}
...
\todo{Include side image of PSC here.}
...
are normally directing the PPC. \todo{What is interesting about internal/voluntary
  attention in CEN?}
...
\todo{Elaborate on breath/bridge and how it relates to brain function?}
...
\todo{Neurological / physiological basis for these strange sensations?}
...
\todo{Relate ``gateway to altered states of mind'' to the Anapana ``bridge''?}
...
day course is well-designed \todo{How is the course well designed?} and will give someone experimenting with meditation the
