...
involved in the perception of facial stimuli. \cite{ipl}.In a study previously conducted where
subjects were asked to retrieve previous judgments about oneself, their friend and the Dutch queen, 
the activation of the IPL decreased with decreasing self reference. \cite{iplself} 
Another study used Transcranial Magnetic Stimulation (TMS) to create a sort of virtual lesion of
...
\todo{Define and describe the MTS: Describe MTL anatomically and MTS relation
  to the DMN, particularly the partial inclusion of the LS.}
...
\todo{Are the labels on either the SVG or the MRI image reversed?}
