...
\todo{Expand on IPL: How does the IPL contribute to our sense of self?}
...
\begin{figure}[h!]
  ...
  \end{subfigure}
  \caption{Highlighted: areas of the brain firing when the Central Executive Network is active.}
  \label{fig:cen}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Location of the Sensory Homunculus.}
...
\begin{figure}[h!]
  ...
  \end{subfigure}
  \caption{Highlighted: areas of the brain firing when the Salience Network is active.}
  \label{fig:sn}
\end{figure}
